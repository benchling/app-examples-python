...
from benchling_sdk.apps.framework import App as BenchlingApp  # as BenchlingApp to alleviate ambiguity with Flask App
from benchling_sdk.benchling import Benchling
from benchling_sdk.auth.client_credentials_oauth2 import ClientCredentialsOAuth2
from benchling_sdk.models.webhooks.v0 import WebhookEnvelopeV0


def init_app_from_webhook(webhook: WebhookEnvelopeV0) -> BenchlingApp:
    return BenchlingApp(webhook.app.id, _benchling_from_webhook(webhook))
